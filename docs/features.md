...
- Add Data menu covering every remote and cloud-native source:
    ...
    - **[WCS raster subsets](data-formats.md#wcs-raster-subsets)**: discover WCS 1.0.0 coverages and download GeoTIFF subsets in EPSG:4326 or EPSG:3857 with explicit extent and pixel dimensions, preserving numerical values for raster inspection and analysis
...
- Data catalog browsers:
    ...
    - **[Ocean Data Platform](https://app.hubocean.earth/catalog)**, HUB Ocean's catalog of public ocean datasets (habitats, protected areas, fisheries, observations); searches it by text, collection, or map view, streams a dataset onto the map as vector tiles, and reads the features in the map view as an editable GeoJSON layer or file
