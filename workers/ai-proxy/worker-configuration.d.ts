/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c2cb109ba85375eca8b03669ba59352e)
...
interface __BaseEnv_Env {
	...
	ALLOWED_MODELS: "openai/gpt-5.6,openai/gpt-5.6-terra,openai/gpt-5.6-luna,anthropic/claude-opus-5,anthropic/claude-sonnet-5,google/gemini-3.6-flash,google/gemini-3.5-flash,google/gemini-3.5-flash-lite";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ALLOWED_MODELS" | "DEFAULT_MODEL" | "AI_GATEWAY_ID" | "MAX_BODY_BYTES" | "MAX_OUTPUT_TOKENS">> {}
}
