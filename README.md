...
- Record the map canvas, or a drawn bounding box, to a video file straight from the browser, and animate a marker along any line layer with 3D track-follow camera controls and MP4 export
