...
// maplibre-gl-raster (re-verified against v0.9.1). All access is optional (?.)
 ...
 * maplibre-gl-raster (re-verified against v0.9.1) rejects non-tiled GeoTIFFs with a message
...
function createRasterControl(
  ...
  // _state.collapsed BEFORE emitting the event (re-verified against v0.9.1) --
...
function patchWebRasterOverlayFactory(
  ...
  // maplibre-gl-raster (re-verified against v0.9.1) calls `_deps.removeOverlay(this._map, this._overlay)`
