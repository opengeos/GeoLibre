...
type LayerFilterSource = Pick<
  GeoLibreLayer,
  "filterExpression" | "quickFilters"
>;
 ...
 */
export function activeLayerFilterExpression(
  layer: LayerFilterSource,
): unknown[] | null {
 ...
 */
export function compileLayerFilters(
  layer: LayerFilterSource,
): unknown[] | null {
  const filters = [
